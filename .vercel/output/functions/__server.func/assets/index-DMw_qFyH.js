...
import { L as Link, P as PHOTOS, c, S as SESSION_TYPES, E as EXPERIENCES } from "./router-CvZrjujd.js";
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "is-dark bg-emerald-deep pt-20 pb-16 sm:pt-28 sm:pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 sm:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-12 md:grid-cols-2 md:gap-10", children: EXPERIENCES.map((exp, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { "data-reveal": true, className: "border-t border-ivory/20 pt-8", style: {
        ...
        exp.photo ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "photo-frame natural", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: exp.photo, alt: `${exp.name} - golden light in open country`, loading: "lazy" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(PhotoPlaceholder, { label: exp.name, className: "aspect-[4/3]" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-parchment/45", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-reveal": true, className: "mx-auto max-w-4xl px-5 py-14 text-center sm:px-8 sm:py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(BotanicalDivider, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 font-accent text-3xl italic leading-snug text-charcoal sm:text-4xl lg:text-[2.9rem]", children: "Storytelling, warm, and never overly posed." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-[0.72rem] font-semibold uppercase tracking-[0.24em] text-forest", children: "Personally tailored for every client" })
    ] }) }),
